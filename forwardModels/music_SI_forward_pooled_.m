%
% music_SI_forward_pooled
% Part of the EEGmusic2020 code.
% Author: Octave Etard
%
% Train a linear forward model by pooling data from the two Single
...
EEGopt = struct();
EEGopt.proc = {'HP-80','HP-80'}; % high-passed at guitar: 175 / piano: 115 Hz

% name of the feature describing the stimulus
featureOpt = struct();
featureOpt.typeName = {'waveform','rectified'}; % 'waveform' or 'WNO' (Waveform No Onsets)
% processing of the feature
featureProc = {'LP-2000','LP-2000'}; % low-passed at 2000 Hz (anti-aliasing / resampling)
...
opt.nFeatures = 2; % 1 predictor feature
